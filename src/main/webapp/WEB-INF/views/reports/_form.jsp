...
<c:if test="${errors != null}">
	<div id="flush_error">
		There is errors in input content.<br>
...
<label for="${AttributeConst.REP_DATE.getValue()}">Date</label><br>
...
<label for="${AttributeConst.REP_TITLE.getValue()}">Title</label><br>
<input type="text" name="${AttributeConst.REP_TITLE.getValue()}" id="${AttributeConst.REP_TITLE.getValue()}" value="${report.title}" />
<br><br>

<label for="${AttributeConst.REP_CONTENT.getValue()}">Content</label><br>
