   ...
   <c:param name="content">
      ...
      <form method="POST"
         ...
         <select name="${AttributeConst.CONFIG_LANGUAGE.getValue()}" id="${AttributeConst.CONFIG_LANGUAGE.getValue()}" >
            <option value="${LanguageClassConst.ENG_US.getLanguageName()}"<c:if test="${LanguageClassConst.getByConfigureView(configure) == LanguageClassConst.ENG_US}"> selected</c:if>>${LanguageClassConst.ENG_US.getDisplayName()}</option>
            <option value="${LanguageClassConst.JPN_JP.getLanguageName()}"<c:if test="${LanguageClassConst.getByConfigureView(configure) == LanguageClassConst.JPN_JP}"> selected</c:if>>${LanguageClassConst.JPN_JP.getDisplayName()}</option>
         </select>
         <br><br>
